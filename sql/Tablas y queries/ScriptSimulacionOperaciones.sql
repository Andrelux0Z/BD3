...
EXEC dbo.SP_SimulacionOperaciones
     @inXML         = @xml
    ,@inIdUsuario   = 1
    ,@outResultCode = @resultCode OUTPUT;

IF (@resultCode = 0)
    PRINT 'Simulacion ejecutada correctamente.';
ELSE
    PRINT 'Error en la simulacion. Codigo: ' + CAST(@resultCode AS VARCHAR);
